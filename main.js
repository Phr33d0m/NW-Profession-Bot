    ...
    * baseProfile - name of base profile to extend. Default is "default" or "XP" in case of Leadership
    ...
    function addProfileToDefined(prof, newProfile, baseProfile){
        ...
        for (var entry in profSet.profiles){
            if  (profSet.profiles[entry] && profSet.profiles[entry].profileName == baseProfile){ bp = profSet.profiles[entry]; break;}
        }
...
/*
	...
	definedTask["Alchemy"] = {
		...
		profiles : [{
			...
			level : {
				...
				21 : ["Alchemy_Tier4_Experiment_Rank22", "Alchemy_Tier3_Experimentation_Rank21", "Alchemy_Tier3_Experimentation_Rank21", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
				22 : ["Alchemy_Tier4_Experiment_Rank23", "Alchemy_Tier3_Experimentation_Rank22", "Alchemy_Tier3_Experimentation_Rank22", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
				23 : ["Alchemy_Tier4_Experiment_Rank24", "Alchemy_Tier3_Experimentation_Rank23", "Alchemy_Tier3_Experimentation_Rank23", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
				24 : ["Alchemy_Tier4_Experiment_Rank25", "Alchemy_Tier3_Experimentation_Rank24", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
				25 : ["Alchemy_Tier4_Experimentation_Rank25", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
			},
		}]
	};
	...
	addProfileToDefined("Alchemy", {
		...
		level: {
			20:["Alchemy_Tier3_Experimentation_Rank20","Alchemy_Tier3_Protection_Potion_Major", "Alchemy_Tier2_Aquaregia", "Alchemy_Tier3_Refine_Basic", "Alchemy_Tier3_Gather_Components"],
		}
	});
	addProfileToDefined("Alchemy", {
        profileName : "Potency",
    ...
    */
    ...
    var settingnames = [
        ...
        {name: 'autovendor_altars_all', title: 'Vendor All Altar', def: false, type: 'checkbox', pane:'vend', tooltip: 'Sell ALL Altars.'},
    ...
    function SelectItemFor(buttonListIn, i, def, prof) {
        ...
        WaitForState("").done(function () {
            ...
            if (prof.taskName === "Leadership") {
                ...
                var T3_Epic = 0; var T3_Rare = 0; var T3_Uncommon = 0; var usedCommon;
                if (settings["smartleadassets"]) {
                    ...
                    usedCommon = countUsedResource("Crafting_Asset_Craftsman_Leadership_T3_Common") 
