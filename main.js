...
(function() {
    ...
    definedTask["Alchemy"] = {
        ...
        profiles: [{
                ...
                level: {
                    ...
                    25: ["Alchemy_Tier4_Experimentation_Rank25", "Alchemy_Tier4_Create_Elemental_Unified", "Alchemy_Tier4_Create_Elemental_Aggregate", "Alchemy_Tier3_Protection_Potion_Major", "Alchemy_Tier3_Potency_Potion_Major", "Alchemy_Tier4_Refine_Basic", "Alchemy_Tier4_Gather_Components"],
                },
            }]
    };
    addProfile("Alchemy", {
    ...
    function updateCounters(reset) {
        ...
        charNameList.forEach(function(charName) {
            ...
            var radh = 0;
            if(counterTime > 0)
                radh = charStatisticsList[charName].general.refineCounter / counterTime;
        ...
        for(var i = 0; i < 3; i++) {
            ...
            if($('#setting__worker__tab__p' + i).val())
                workerTabSelects[i] = $('#setting__worker__tab__p' + i).val();
        ...
        for(var i = 0; i < 4; i++) {
            //saving current select values
            if($('#setting__tools__tab__p' + i).val())
                toolsTabSelects[i] = $('#setting__tools__tab__p' + i).val();
